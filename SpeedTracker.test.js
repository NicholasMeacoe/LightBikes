...
describe('SpeedTracker', () => {
    ...
    describe('Multiple Entity Tracking', () => {
        ...
        it('should calculate maximum speed correctly', () => {
            // Set different speeds for entities
            mockGameState.player.x = 6; // Speed ~62.5
            mockGameState.aiOpponents[0].x = 13; // Speed ~187.5
            mockGameState.aiOpponents[1].x = 15.5; // Speed ~31.25
        ...
        it('should calculate average speed correctly', () => {
            // Set known speeds
            mockGameState.player.x = 6; // Speed ~62.5
            mockGameState.aiOpponents[0].x = 12; // Speed ~125
            mockGameState.aiOpponents[1].x = 15.5; // Speed ~31.25
    ...
    describe('Error Handling', () => {
        it('should handle entity update errors gracefully', () => {
            const faultyEntity = {
                get x() { throw new Error('Property access error'); },
                z: 0
            };
