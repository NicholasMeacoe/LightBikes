...
class PerformanceOptimizer {
    ...
    getOrCreateTexture(type, key, createFn) {
        ...
        if (!pool) {
            console.warn('Unknown texture pool type:', type);
            return null;
        }
    ...
    applyTrailLOD(cameraPosition) {
        ...
        this.scene.traverse((object) => {
            if (object.userData && object.userData.materialId && 
        ...
        this.scene.traverse((object) => {
            if (object.userData && object.userData.effectType) {
                ...
                if (distance > lodConfig.culled.distance) {
                    ...
                    object.visible = true;
                    if (object.material && object.material.emissiveIntensity !== undefined) {
                        object.material.emissiveIntensity = object.userData.originalEmissiveIntensity || 0.5;
                    }
                }
            }
        });
    ...
    updatePerformanceMetrics() {
        ...
        this.performanceMetrics.geometryCount = info.memory.geometries;
        this.performanceMetrics.textureCount = info.memory.textures;
    ...
    startPerformanceMonitoring() {
        ...
        setInterval(() => {
            ...
            if (!this.isPerformanceAcceptable()) {
                console.warn('Performance below target:', this.performanceMetrics);
            }
        }, 1000);
    }
