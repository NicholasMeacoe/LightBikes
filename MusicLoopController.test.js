...
describe('MusicLoopController', () => {
    ...
    describe('loop starting', () => {
        ...
        it('should throw error for unloaded track', async () => {
            ...
            await expect(loopController.startLoop(mockTrack, mockDestination)).rejects.toThrow('Track must be loaded before starting loop');
        });

        it('should throw error for track without audio buffer', async () => {
            mockTrack.getAudioBuffer = () => null;
            
            await expect(loopController.startLoop(mockTrack, mockDestination)).rejects.toThrow('Audio buffer not available for looping');
        });
    ...
    describe('error handling', () => {
        it('should handle source creation failure', async () => {
            ...
            await expect(loopController.startLoop(mockTrack, mockDestination)).rejects.toThrow('Failed to create audio source for looping');
        });
