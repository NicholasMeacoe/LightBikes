...
describe('PositionManager', () => {
    describe('calculateStartingPositions', () => {
        ...
        it('should throw error for invalid AI count', () => {
            expect(() => PositionManager.calculateStartingPositions(0)).toThrow(
                'AI count must be a number between 1 and 4'
            );
            expect(() => PositionManager.calculateStartingPositions(5)).toThrow(
                'AI count must be a number between 1 and 4'
            );
            expect(() => PositionManager.calculateStartingPositions(-1)).toThrow(
                'AI count must be a number between 1 and 4'
            );
            expect(() => PositionManager.calculateStartingPositions('2')).toThrow(
                'AI count must be a number between 1 and 4'
            );
            expect(() => PositionManager.calculateStartingPositions(null)).toThrow(
                'AI count must be a number between 1 and 4'
            );
        });

        it('should throw error for invalid arena size', () => {
            expect(() => PositionManager.calculateStartingPositions(2, 5)).toThrow(
                'Arena size must be a number between 10 and 100'
            );
            expect(() => PositionManager.calculateStartingPositions(2, 101)).toThrow(
                'Arena size must be a number between 10 and 100'
            );
            expect(() => PositionManager.calculateStartingPositions(2, 'invalid')).toThrow(
                'Arena size must be a number between 10 and 100'
            );
            expect(() => PositionManager.calculateStartingPositions(2, null)).toThrow(
                'Arena size must be a number between 10 and 100'
            );
        });
    ...
    describe('getInitialDirection', () => {
        ...
        it('should throw error for invalid angles', () => {
            expect(() => PositionManager.getInitialDirection('invalid')).toThrow(
                'Angle must be a finite number'
            );
            expect(() => PositionManager.getInitialDirection(null)).toThrow(
                'Angle must be a finite number'
            );
            expect(() => PositionManager.getInitialDirection(undefined)).toThrow(
                'Angle must be a finite number'
            );
            expect(() => PositionManager.getInitialDirection(Infinity)).toThrow(
                'Angle must be a finite number'
            );
            expect(() => PositionManager.getInitialDirection(NaN)).toThrow(
                'Angle must be a finite number'
            );
        });
    ...
    describe('calculateSafeStartingPositions', () => {
        it('should return positions with minimum distance', () => {
            ...
            const distance = Math.sqrt(
                (positions[0].x - positions[1].x) ** 2 + (positions[0].z - positions[1].z) ** 2
            );
        ...
        it('should throw error for invalid minimum distance', () => {
            expect(() => PositionManager.calculateSafeStartingPositions(2, 30, 0)).toThrow(
                'Minimum distance must be a positive number'
            );
            expect(() => PositionManager.calculateSafeStartingPositions(2, 30, -1)).toThrow(
                'Minimum distance must be a positive number'
            );
            expect(() => PositionManager.calculateSafeStartingPositions(2, 30, 'invalid')).toThrow(
                'Minimum distance must be a positive number'
            );
        });
