...
describe('PerformanceOptimizer', () => {
    ...
    describe('getOrCreateThemeMaterial', () => {
        it('should create grid theme material', () => {
            ...
            const material = performanceOptimizer.getOrCreateThemeMaterial('classic-grid', 'grid', config);
        ...
        it('should create background theme material', () => {
            ...
            const material = performanceOptimizer.getOrCreateThemeMaterial('classic-grid', 'background', config);
        ...
        it('should reuse theme materials', () => {
            const config = { color: 0x00FFFF, opacity: 0.3 };
            const material1 = performanceOptimizer.getOrCreateThemeMaterial('classic-grid', 'grid', config);
            const material2 = performanceOptimizer.getOrCreateThemeMaterial('classic-grid', 'grid', config);
    ...
    describe('getOrCreateTexture', () => {
        it('should create new texture using create function', () => {
            ...
            const texture = performanceOptimizer.getOrCreateTexture('gradients', 'test-key', createFn);
        ...
        it('should reuse existing texture', () => {
            ...
            const texture1 = performanceOptimizer.getOrCreateTexture('gradients', 'test-key', createFn);
            const texture2 = performanceOptimizer.getOrCreateTexture('gradients', 'test-key', createFn);
        ...
        it('should return null for unknown texture pool type', () => {
            ...
            const texture = performanceOptimizer.getOrCreateTexture('unknown', 'test-key', createFn);
