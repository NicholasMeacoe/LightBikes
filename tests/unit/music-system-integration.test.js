...
describe.skip('Music System Integration Tests', () => {
    ...
    describe('AudioManager Integration', () => {
        it('should integrate music player with audio manager', () => {
            ...
            expect(audioManager.isMusicAvailable()).toBeTruthy();
        });
    ...
    describe('Sound Effect Integration', () => {
        ...
        it.skip('should duck music during victory sounds', () => {
            jest.useFakeTimers();
            jest.spyOn(musicPlayer, 'onSoundEffect').mockReturnValue(true);

            audioManager.playVictorySound();

            // Victory sound has a delay, so we need to advance timers
        ...
        it.skip('should duck music during defeat sounds', () => {
            jest.spyOn(musicPlayer, 'onSoundEffect').mockReturnValue(true);
