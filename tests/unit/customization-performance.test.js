/**
 * Performance and Scalability Tests for Customization System
 */
...
describe('Customization Performance', () => {
    ...
    it('should handle many customization applications', () => {
        for (let i = 0; i < 50; i++) {
            customizationManager.setBikeColor('player', i % 2 === 0 ? '#FF0000' : '#00FF00');
        }
        expect(customizationManager.getCurrentState().bikeColor).toMatch(/^#(FF0000|00FF00)$/);
    });
});
