...
describe('PreferenceStorage', () => {
    ...
    describe('savePreferences', () => {
        ...
        it('should include version and timestamp in saved data', () => {
            ...
            const dataCall = calls.find(call => call[0] === 'lightbikes_customization_preferences');
    ...
    describe('loadPreferences', () => {
        it('should load valid preferences from localStorage', () => {
            ...
            expect(mockLocalStorage.getItem).toHaveBeenCalledWith('lightbikes_customization_preferences');
        });
        ...
        it('should handle corrupted JSON data', () => {
            ...
            expect(result).toBeNull();
            expect(mockLocalStorage.removeItem).toHaveBeenCalledWith('lightbikes_customization_preferences');
        });
    ...
    describe('data validation', () => {
        ...
        it('should reject invalid data structures', () => {
            ...
            expect(preferenceStorage.validateStorageData({
                version: '1.0'
