...
describe('ChatSystem', () => {
    ...
    describe('renderMessage', () => {
        ...
        it('should render chat message', () => {
            ...
            const messageEl =
                chatSystem.elements.messagesContainer.querySelector('.chat-message-chat');
        ...
        it('should render system message with different styling', () => {
            ...
            const messageEl =
                chatSystem.elements.messagesContainer.querySelector('.chat-message-system');
            expect(messageEl).toBeTruthy();
        });
    ...
    describe('mutePlayer', () => {
        ...
        it('should remove existing messages from muted player', () => {
            ...
            expect(chatSystem.elements.messagesContainer.textContent).toContain(
                'Message before mute'
            );

            chatSystem.mutePlayer('player-2');

            expect(chatSystem.elements.messagesContainer.textContent).not.toContain(
                'Message before mute'
            );
        });
    });
    ...
    describe('reportPlayer', () => {
        ...
        it('should show confirmation message', () => {
            ...
            expect(
                chatSystem.messages.some((msg) => msg.message.includes('Reported Player 2'))
            ).toBe(true);
        });
