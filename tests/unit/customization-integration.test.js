...
describe('Customization System Integration', () => {
    ...
    beforeEach(() => {
        ...
        // Create fresh rendering engine mock
        mockRenderingEngine = {
    ...
    describe('End-to-End Color Customization', () => {
        it('should allow complete bike color customization workflow', () => {
            ...
            const savedData = global.localStorage.getItem('lightbikes_customization_preferences');
    ...
    describe('Preference Persistence Integration', () => {
        it('should save and load preferences correctly', () => {
            ...
            // 3. Verify data was saved to localStorage
            const savedData = global.localStorage.getItem('lightbikes_customization_preferences');
            expect(savedData).toBeTruthy();

            const parsedData = JSON.parse(savedData);
            expect(parsedData.preferences.bikeColor).toBe('#FF0000');
            expect(parsedData.preferences.trailColor).toBe('#0000FF');
            expect(parsedData.preferences.trailStyle).toBe('glowing');
        });
        ...
        it('should load saved preferences on initialization', () => {
            ...
            const newManager = new CustomizationManager(
                mockRenderingEngine,
    ...
    describe('EmissiveMaterialSystem Integration', () => {
        it('should integrate with emissive material system correctly', () => {
            ...
            customizationManager.setTrailColor('player', '#0000FF');
            expect(materialSystem.updateTrailMaterialTemplate).toHaveBeenCalledWith(
                'player',
                0x0000ff
            );
    ...
    describe('Error Handling Integration', () => {
        ...
        it('should handle storage errors gracefully', () => {
            // Mock storage error by replacing setItem temporarily
