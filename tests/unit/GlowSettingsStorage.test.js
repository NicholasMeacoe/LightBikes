...
describe('GlowSettingsStorage', () => {
    ...
    describe('backup and recovery', () => {
        ...
        it('should recover from backup when primary is corrupted', () => {
            ...
            // Valid backup
            mockLocalStorage.data['lightbikes_glow_settings_backup'] =
            ...
            expect(mockLogger.warn).toHaveBeenCalledWith(
                'Primary settings corrupted, attempting backup recovery'
            );
        });
    ...
    describe('settings migration', () => {
        it('should migrate settings from version 0 to 1', () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith(
                'Migrated glow settings from version 0 to 1'
            );
        });
