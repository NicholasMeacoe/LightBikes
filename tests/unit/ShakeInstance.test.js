...
describe('ShakeInstance', () => {
    ...
    describe('offset generation', () => {
        ...
        it('should scale offset with intensity', () => {
            ...
            const smallMagnitude = Math.sqrt(
                smallOffset.x ** 2 + smallOffset.y ** 2 + smallOffset.z ** 2
            );
            const largeMagnitude = Math.sqrt(
                largeOffset.x ** 2 + largeOffset.y ** 2 + largeOffset.z ** 2
            );
