...
describe('PowerUpManager', () => {
    ...
    describe('applyEffect', () => {
        ...
        it('should apply Trail Eraser effect and remove trail segments', () => {
            ...
            const playerTrail = [
                ...
                { x: 4, z: 4 }, { x: 5, z: 5 }, { x: 6, z: 6 },
                { x: 7, z: 7 }, { x: 8, z: 8 }, { x: 9, z: 9 },
                { x: 10, z: 10 }, { x: 11, z: 11 }, { x: 12, z: 12 }
            ];
            ...
            const trailManager = new PowerUpManager(mockGameWithTrail, mockRenderer, mockCollisionDetector);
    ...
    describe('renderer integration', () => {
        it('should call renderer.registerPowerUps when updateRenderer is called', () => {
            ...
            const powerUpManagerWithRenderer = new PowerUpManager(mockGame, mockRenderer, mockCollisionDetector);
        ...
        it('should trigger collection feedback with audio and visual effects', () => {
            const mockRenderer = {
                createCollectionParticles: jest.fn(),
            ...
            const powerUpManagerWithFeedback = new PowerUpManager(mockGame, mockRenderer, mockCollisionDetector, mockAudioManager);
            ...
            expect(mockRenderer.createCollectionParticles).toHaveBeenCalledWith(
                collection.position,
...
describe('ActiveEffect', () => {
    it('should initialize with correct properties', () => {
        ...
        const effect = new ActiveEffect('player', 'SPEED_BOOST', startTime, 3000, { multiplier: 2.0 });
...
describe('PowerUpManager - Comprehensive Test Suite', () => {
    ...
    beforeEach(() => {
        ...
        powerUpManager = new PowerUpManager(mockGameWithComplexState, mockRenderer, mockCollisionDetector);
    });
    ...
    describe('Spawn Logic and Validation', () => {
        ...
        it('should validate spawn positions against trails', () => {
            ...
            expect(powerUpManager.isValidSpawnPosition(tooCloseToPlayerTrail, gameState)).toBe(false);
    ...
    describe('Effect Expiration and Cleanup', () => {
        ...
        it('should handle effect expiration callbacks', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('Speed boost expired for player');
            expect(consoleSpy).toHaveBeenCalledWith('Ghost mode expired for player');
            expect(consoleSpy).toHaveBeenCalledWith('Shield expired for player');
    ...
    describe('Trail Eraser Edge Cases', () => {
        it('should handle trail eraser with empty trail', () => {
            ...
            const trailManager = new PowerUpManager(emptyTrailGame, mockRenderer, mockCollisionDetector);
            const success = trailManager.applyEffect('player', 'TRAIL_ERASER');
        ...
        it('should handle trail eraser with short trail', () => {
            ...
            const shortTrail = [{ x: 1, z: 1 }, { x: 2, z: 2 }, { x: 3, z: 3 }];
            ...
            const trailManager = new PowerUpManager(shortTrailGame, mockRenderer, mockCollisionDetector);
            const success = trailManager.applyEffect('player', 'TRAIL_ERASER');
